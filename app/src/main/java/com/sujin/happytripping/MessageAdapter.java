...
public class MessageAdapter extends ArrayAdapter<MessageFormat> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(TextUtils.isEmpty(message.getMessage())){
            ...
            Log.i(ChatBox.TAG, "getView: is empty ");
            String userConnected = message.getUsername();
            messageText.setText(userConnected);

        }else if(message.getUniqueId().equals(ChatBox.uniqueId)){
            Log.i(ChatBox.TAG, "getView: " + message.getUniqueId() + " " + ChatBox.uniqueId);
            ...
            Log.i(ChatBox.TAG, "getView: is not empty");
